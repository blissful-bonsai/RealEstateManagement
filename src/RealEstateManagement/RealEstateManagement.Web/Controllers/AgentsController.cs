...
using RealEstateManagement.DAO;
...
namespace RealEstateManagement.Web
{
    public class AgentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AgentId,Name,Cpf,Creci,Phone,Email")] Agent agent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AgentId,Name,Cpf,Creci,Phone,Email")] Agent agent)
        {
            if (id != agent.AgentId)
            {
                return NotFound();
